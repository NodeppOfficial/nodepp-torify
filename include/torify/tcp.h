...
namespace nodepp { class tcp_torify_t {
private:
...
public:
    ...
    event_t<ptr_t<tcp_torify_t>,socket_t> onSocket ;
    event_t<>                             onClose  ;
   ...
   ~tcp_torify_t() noexcept { if( obj.count() > 1 ){ return; } free(); }
    ...
    expected_t<tcp_torify_t,except_t>
...
namespace nodepp { namespace torify { namespace tcp {
