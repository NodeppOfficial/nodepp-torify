...
namespace nodepp { struct torify_fetch_t : public fetch_t { string_t proxy; };}
#endif
...
namespace nodepp { namespace torify { namespace https {
    ...
    inline promise_t<https_t,except_t> fetch ( const torify_fetch_t& fetch, ssl_t* ssl=nullptr, torify_agent_t* opt=nullptr, function_t<void,https_t> clb=nullptr ) {
